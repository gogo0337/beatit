...
{name:'ㅋㅋㅋ',         cat:'밈',     e:'😹',  fn: 'speech:ㅋㅋㅋㅋㅋ'},
{name:'존맛탱',         cat:'밈',     e:'😍',  fn: 'speech:존맛탱이야!'},
...
{name:'갓생',           cat:'밈',     e:'✨',  fn: 'speech:갓생이다!'},
{name:'솔직히',         cat:'밈',     e:'🙋',  fn: 'speech:솔직히'},
{name:'TMI지만',        cat:'밈',     e:'💬',  fn: 'speech:T M I지만'},
{name:'빠라빠빠',       cat:'밈',     e:'🍟',  fn: 'speech:빠라빠빠빠'},
{name:'칼퇴',           cat:'밈',     e:'🏃',  fn: 'speech:칼퇴한다!'},
{name:'야 이게 뭐야',   cat:'밈',     e:'😵',  fn: 'speech:야 이게 뭐야'},
